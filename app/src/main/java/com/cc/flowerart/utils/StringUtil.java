...
public class StringUtil {
    ...
    public static String URL2ID(String URL){
        String newStr = replace(URL,"http://ot4o92kcv.bkt.clouddn.com/","");
        newStr = replace(newStr,".","");
        newStr = replace(newStr,"com","");
        newStr = replace(newStr,"jpg","");
        newStr = replace(newStr,"png","");
        newStr = replace(newStr,"jpeg","");
        newStr = replace(newStr,"/","");
        return newStr;
    }
     ...
     * @return
     */
    public static String getUniqueId(int longth) {
        String s = UUID.randomUUID().toString();
        s = s.replace("-", "");
        int i = (int) (Math.random() * (s.length() - longth));
        s.substring(i, i + longth);
        s = (String) s.subSequence(i, i + longth);
        return s;
    }
